(ns metaltreatmfg.registry-test
  (:require [clojure.test :refer [deftest is]]
            [metaltreatmfg.registry :as r]))
...
(deftest known-product-categories-are-valid
  (doseq [c [:electroplated-item :anodized-item :powder-coated-item
...
(deftest history-is-append-only
  (let [c1 (r/register-maintenance "mnt-1" "plate-001" 0)
        hist (r/append [] c1)
        c2 (r/register-maintenance "mnt-2" "plate-001" 1)
