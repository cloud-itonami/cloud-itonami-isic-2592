(ns metaltreatmfg.phase
  "Phase 0->3 staged rollout for the metal-treatment/coating/machining
  job-shop plant-operations coordination actor.
  ...
  consequence (an electroplating-bath/anodizing-tank/heat-treatment-
  furnace/CNC-machine maintenance window means production downtime,
  and the equipment ends up actually touched); it is always a human
  shop supervisor's call. `metaltreatmfg.governor`'s
  `plating-machining-line-actuate-blocked-violations` HARD-blocks
...
(defn verdict->disposition
  "Map a Metal Treatment, Coating & Machining Plant Operations Governor
