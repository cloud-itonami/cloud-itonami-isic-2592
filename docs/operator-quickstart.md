# Operator Quickstart — Treatment and coating of metals; machining

Shortest path from clone to a verified local dry-run for **ISIC 2592** (`cloud-itonami-isic-2592`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2592.git
cd cloud-itonami-isic-2592
```
...
- Blueprint governor key: `metal-treatment-coating-machining-plant-operations-governor`
- Likely source path: `metaltreatmfg.governor.cljc`
